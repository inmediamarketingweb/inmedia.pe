...
// fetch('http://localhost/xampp/inmedia.pe/servicios/diseno-grafico/servicios.json')
fetch('https://inmedia.pe/servicios/diseno-grafico/servicios.json')
...
function renderizarPaquetes(servicio, slug) {
    ...
    servicio.paquetes.forEach(paquete => {
        ...
        const linkTexto = `Hola! *Inmedia Marketing Web* estoy interesado en adquirir el paquete: Diseño gráfico > ${servicio.titulo[0]["span-1"]} ${servicio.titulo[0]["span-2"]} > ${paquete.titulo}`;
