...
const url = 'https://inmedia.pe/servicios/infraestructura-ti/hosting-y-dominio/paquetes.json';
...
function renderPaquetes(paquetes){
    ...
    paquetes.forEach(paquete => {
        ...
        const linkTexto = `Hola! *Inmedia Marketing Web* estoy interesado en adquirir el paquete: Hosting y Dominio > ${paquete.titulo}`;
